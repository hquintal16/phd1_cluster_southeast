...
library(here)
here::i_am("scripts/05_covariance_precipitation.R")
...
for (year in year_month){
  ...
  space <- read.csv(here::here("data", "output", "02_covariance", "02_experimental_covariance", "precipitation", "month",
                               paste0("precipitation_experimental_covariance_space_", year, ".txt")))
  time <- read.csv(here::here("data", "output", "02_covariance", "02_experimental_covariance", "precipitation", "month",
                              paste0("precipitation_experimental_covariance_time_", year, ".txt"))) 
...
# save STM
write.csv(stm, here("data", "output", "02_covariance", "03_space_time_metric", "precipitation", "month", "precipitation_space_time_metric_optimal.txt"))
write.csv(stm.exp,here("data", "output", "02_covariance", "03_space_time_metric", "precipitation", "month", "precipitation_space_time_metric_single_exponential.txt"))
write.csv(stm.gau,here("data", "output", "02_covariance", "03_space_time_metric", "precipitation", "month", "precipitation_space_time_metric_single_gaussian.txt"))
write.csv(stm.exp.exp,here("data", "output", "02_covariance", "03_space_time_metric", "precipitation", "month", "precipitation_space_time_metric_nested_exponential.txt"))
write.csv(stm.gau.exp,here("data", "output", "02_covariance", "03_space_time_metric", "precipitation", "month", "precipitation_space_time_metric_nested_gaussian_exponential.txt"))
...
#                   figure.number = '3',
#                   figure.name = paste0('Precipitation_Covariance_Model_',seq(1940,2023,1)[fig]),
