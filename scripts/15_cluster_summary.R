...
processed_dirs <- list(here('data','output','03_cluster','02_cluster','24hr1yr','points','county'))
output_path <- here('data','output','03_cluster','02_cluster','24hr1yr','points','summary')
