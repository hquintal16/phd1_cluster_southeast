...
#   # Required columns:
#   # - start_time (Time)
#   # - min_heat_index (Minimum Heat Index in °C)
...
#   # Combine both datasets so that scales (time, min_heat_index, duration, exposed_area) are normalized.
...
#     scale_y_continuous(limits = global_y_range) +
...
#   png_path_noaa    <- here("figures", paste0("05_", noaa_base, "_plot.png"))
#   svg_path_noaa    <- here("figures", paste0("05_", noaa_base, "_plot.svg"))
#   png_path_cluster <- here("figures", paste0("05_", cluster_base, "_plot.png"))
#   svg_path_cluster <- here("figures", paste0("05_", cluster_base, "_plot.svg"))
#   
#   # Save NOAA plot
...
plot_normalized_time_series_updated <- function(noaa_path, cluster_path, date_format = "%m/%d/%Y") {
  ...
  plot_noaa <- ggplot(noaa_data, aes(x = start_time, y = era5_mean,
    ...
    scale_y_continuous(limits = c(35, global_y_range[2])) +
...
results <- plot_normalized_time_series_updated(
  ...
  cluster_path = here::here("data", "output", "05_validation", "summary", "cluster", "cluster_0.25_excess_heat_summary.csv")
)
# Example usage:
results <- plot_normalized_time_series_updated(
  noaa_path = here::here("data", "output", "05_validation", "summary", "noaa", "NOAA_excess_heat_summary.csv"),
  cluster_path = here::here("data", "output", "05_validation", "summary", "cluster", "cluster_0.3075_excess_heat_summary.csv")
)
# Example usage:
results <- plot_normalized_time_series_updated(
  noaa_path = here::here("data", "output", "05_validation", "summary", "noaa", "NOAA_excess_heat_summary.csv"),
  cluster_path = here::here("data", "output", "05_validation", "summary", "cluster", "cluster_0.39_excess_heat_summary.csv")
)
# # Example usage:
# results <- plot_normalized_time_series_updated(noaa_dir = here::here("data", "output", "05_validation", "summary","noaa","NOAA_excess_heat_summary.csv"), 
#                                                cluster_dir = here::here("data", "output", "05_validation", "summary","cluster","cluster_0.25_excess_heat_summary.csv"))
