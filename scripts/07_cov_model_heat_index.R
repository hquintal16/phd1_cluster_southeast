...
# Create data frames
stm <- data.frame(year_mo = seq(1940,2023,1), sill = NA,
                  alpha1 = NA, alpha2 = NA,
                  at1 = NA, ar1 = NA, 
                  at2 = NA, ar2 = NA, 
                  sse = NA,
...
stm.exp.exp <- data.frame(year_mo = seq(1940,2023,1), sill = NA,
                          alpha1 = NA, alpha2 = NA,
                          at1 = NA, ar1 = NA, 
                          at2 = NA, ar2 = NA, 
                          sse = NA,
...
stm.gau.exp <- data.frame(year_mo = seq(1940,2023,1), sill = NA,
                          alpha1 = NA, alpha2 = NA,
                          at1 = NA, ar1 = NA, 
                          at2 = NA, ar2 = NA, 
                          sse = NA,
...
stm.exp <- data.frame(year_mo = seq(1940,2023,1), sill = NA,
                          at = NA, ar = NA,  
                          sse = NA, stm = NA)

stm.gau <- data.frame(year_mo = seq(1940,2023,1), sill = NA,
                      at = NA, ar = NA,  
                      sse = NA, stm = NA)
...
for (year in seq(1940,2023,1)){
  ...
  space <- read.csv(paste0('V:/users/hquintal/phd2_southeast/data/output/02_geoeas/02_experimental_covariance/heat_index/year/heat_index_experimental_covariance_space_',year,'.txt'))
  time <- read.csv(paste0('V:/users/hquintal/phd2_southeast/data/output/02_geoeas/02_experimental_covariance/heat_index/year/heat_index_experimental_covariance_time_',year,'.txt'))
...
# save STM
write.csv(stm,'V:/users/hquintal/phd2_southeast/data/output/02_geoeas/03_space_time_metric/heat_index/year/heat_index_space_time_metric_optimal.txt')
write.csv(stm.exp,'V:/users/hquintal/phd2_southeast/data/output/02_geoeas/03_space_time_metric/heat_index/year/heat_index_space_time_metric_single_exponential.txt')
write.csv(stm.gau,'V:/users/hquintal/phd2_southeast/data/output/02_geoeas/03_space_time_metric/heat_index/year/heat_index_space_time_metric_single_gaussian.txt')
write.csv(stm.exp.exp,'V:/users/hquintal/phd2_southeast/data/output/02_geoeas/03_space_time_metric/heat_index/year/heat_index_space_time_metric_nested_exponential.txt')
write.csv(stm.gau.exp,'V:/users/hquintal/phd2_southeast/data/output/02_geoeas/03_space_time_metric/heat_index/year/heat_index_space_time_metric_nested_gaussian_exponential.txt')
...
for (year in year_month){
  ...
  # Read in experimental covariance
  space <- read.csv(paste0('V:/users/hquintal/phd2_southeast/data/output/02_geoeas/02_experimental_covariance/heat_index/month/heat_index_experimental_covariance_space_',year,'.txt'))
  time <- read.csv(paste0('V:/users/hquintal/phd2_southeast/data/output/02_geoeas/02_experimental_covariance/heat_index/month/heat_index_experimental_covariance_time_',year,'.txt'))
...
# save STM
write.csv(stm,'V:/users/hquintal/phd2_southeast/data/output/02_geoeas/03_space_time_metric/heat_index/month/heat_index_space_time_metric_optimal.txt')
write.csv(stm.exp,'V:/users/hquintal/phd2_southeast/data/output/02_geoeas/03_space_time_metric/heat_index/month/heat_index_space_time_metric_single_exponential.txt')
write.csv(stm.gau,'V:/users/hquintal/phd2_southeast/data/output/02_geoeas/03_space_time_metric/heat_index/month/heat_index_space_time_metric_single_gaussian.txt')
write.csv(stm.exp.exp,'V:/users/hquintal/phd2_southeast/data/output/02_geoeas/03_space_time_metric/heat_index/month/heat_index_space_time_metric_nested_exponential.txt')
write.csv(stm.gau.exp,'V:/users/hquintal/phd2_southeast/data/output/02_geoeas/03_space_time_metric/heat_index/month/heat_index_space_time_metric_nested_gaussian_exponential.txt')
