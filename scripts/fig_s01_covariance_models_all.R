...
here::i_am("scripts/fig_s01_covariance_models.R")  # Adjust this file path as needed
...
png_path <- here("figures","s01_covariance.png")
svg_path <- here("figures","s01_covariance.svg")
